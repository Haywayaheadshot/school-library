...
describe Solver do
    context 'Check for correct values passed through factorial class' do
        instance = Solver.new
        fact_num = instance.factorial(5)
        fact_num_2 = instance.factorial(0)
        fact_num_3 = instance.factorial(-1)
        ...
        it 'Check for the factorial of 5' do
          expect(fact_num).to eql (120)
        end

        it 'Check for the factorial of 0' do
            expect(fact_num_2).to eql (1)
        end

        it 'Check for the factorial of -1' do
            expect(fact_num_3).to eql ('The number is a negative number')
        end
